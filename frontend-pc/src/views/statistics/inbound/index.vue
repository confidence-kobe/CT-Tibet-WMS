<template>
  <div class="statistics-inbound-container page-container">
    <!-- 页面头部 -->
    <div class="page-header">
      <h2 class="page-title">入库统计</h2>
    ...
    <el-row :gutter="16" style="margin-top: 16px;">
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <el-statistic title="入库总次数" :value="stats.totalCount">
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <el-statistic title="入库总数量" :value="stats.totalQuantity">
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <el-statistic title="入库总金额" :value="stats.totalAmount" :precision="2">
      ...
      <el-col :span="6">
        <el-card shadow="hover" class="stat-card">
          <el-statistic title="日均入库" :value="stats.avgDaily" :precision="1">
      ...
      <el-col :span="12">
        <el-card shadow="never">
          ...
          <el-table :data="tableData" stripe border max-height="350">
            ...
            <el-table-column prop="count" label="入库次数" width="100" align="right" />
            <el-table-column prop="quantity" label="入库数量" width="100" align="right" />
            <el-table-column prop="amount" label="入库金额" align="right">
...
import { getInboundStatistics } from '@/api/statistics'
...
const handleQuery = async () => {
  try {
    ...
    const res = await getInboundStatistics(params)
    const data = res.data || {}
...
const updateLineChart = (data) => {
  const option = {
    title: { text: '入库趋势图', left: 'center' },
    tooltip: { trigger: 'axis', axisPointer: { type: 'cross' } },
    legend: { data: ['入库数量', '入库金额'], top: 30 },
