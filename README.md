...
- ✅ **测试完成**: 150个测试用例，100%通过率，26个测试类覆盖全链路
...
| 部门管理员 | dept_admin | 123456 | 部门管理权限 |
| 仓库管理员 | warehouse_manager | 123456 | 仓库管理权限 |
| 普通员工 | employee | 123456 | 基本申请权限 |
...
失败: 0
通过率: 100% 🎊
覆盖层次: Controller(6) + Service(10) + Integration(1) + Unit(9)
```
